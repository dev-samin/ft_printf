...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/05 20:45:15 by samin             #+#    #+#             */
/*   Updated: 2021/03/05 21:29:20 by samin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	print_u_1(t_flag *flag, unsigned int content, char padding_char)
{
...
void	print_u_2(t_flag *flag, unsigned int content, char padding_char)
{
	while (flag->precision_len-- > 0)
	{
		custum_putnbr_fd(flag, 0, 1);
...
void	type_u(t_flag *flag, va_list ap)
{
	...
	if (flag->minus == 0)
		print_u_1(flag, content, padding_char);
	else
		print_u_2(flag, content, padding_char);
}
